/**
 * Oracle-free properties of the canonical erf/erfc/GELU (src/index.ts, #122):
 * special values, symmetry identities, the f32-lowering truncation bound that
 * tensor-webgpu's WGSL relies on, gelu modes, and the derivative.
 * Accuracy against SciPy lives in special-oracle.test.ts.
 */
