/**
 * SciPy differential oracle for the canonical erf/erfc/exact GELU (src/index.ts, issue #122):
 * `scipy.special.erf` / `erfc` over [-6, 6] (dense) plus both tails out to
 * erfc's f64 underflow, and `x·special.ndtr(x)` as a tail-accurate
 * exact-GELU reference. (PyTorch parity for `Tensor.gelu()` is in
 * tensor-core's special-oracle.test.ts.)
 *
...
import { erf, erfc, geluErf } from "../src/index.ts";
